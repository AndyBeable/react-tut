# A component is a function or a class that produces HTML to show a user (using JSX) and handles feedback from a user (event handlers)

## 3 tenants of components

- Component Nesting - a component can be shown inside of another
- Component Reusability - aim to make components that can be reused easily across our app
